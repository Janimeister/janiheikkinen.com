...
const PAGES = [
  ...
  { path: '/searching', name: 'Searching', waitSection: null },
  { path: '/pathfinding', name: 'Pathfinding', waitSection: null },
  ...
  { path: '/third-party-notices', name: 'Third-Party Notices', waitSection: 'Open Source Software' },
] as const;
